...
for sim_num in range(0,simulations):
    ...
    for pack in range(0,num_packs):
        ...
        if (pack + 1) % pack_increment == 0:
            ...
            if liquefy_priority == 'Animated':
                new_vial_total = potential_vials(cards_w_copies_over, count_cards, count_cards_w_ani, 'A', vials_liquefied_ani, vials_liquefied_non)
            elif liquefy_priority == 'Normal':
